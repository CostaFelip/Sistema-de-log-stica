      ...
      <main className="flex-1 p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            {!isGerente && <p className="text-sm text-gray-400 mt-1">Mostrando ordens do seu setor</p>}
          </div>
          {aba === 'ordens' && (
              ...
              <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-gray-600">
                    {filtradas.length === 0 ? (
                      <tr><td colSpan={9} className="px-6 py-12 text-center text-gray-400">Nenhuma ordem cadastrada</td></tr>
                    ) : filtradas.map(o => (
            ...
            {produtoEncontrado && (
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  {fornecedoresFiltrados.length > 0 && <p className="text-xs text-blue-600 mb-2">Sugeridos pela categoria do produto</p>}
